          ...
          <div class="dir-single-content__details dir-single-content--part"><?php
            ...
            if($row->contact_info_email){ ?>
              <div class="dir-single-content__detail detail--email">
                  ...
                  <a href="mailto:<?=$row->contact_info_email?>" target="_blank"><span><?= $row->contact_info_email?></span></a>
              </div><?php
            }
                ...
                while(have_rows('your_studios_studio')){
                  ...
                  if(get_sub_field('studio_type') === 'lyt_studio'){
                    ...
                    <div class="my-studio__link--site">
                      <a href="<?= $lyt_row->contact_info_website?>" class="button">Visit Studio</a>
                    </div><?php
                  } else {?>
                    <div class="my-studio"><?php
                      $website = get_sub_field('studio_website');
                      if(have_rows('studio_address')):
                        the_row();?>
                    ...
                    <div class="my-studio--link">
                      <a href="<?= $website?>" target="_blank" class="button">Visit Studio</a>
                    </div><?php
                  }?>
